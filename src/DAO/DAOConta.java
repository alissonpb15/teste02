...
*/
public class DAOConta extends ConexaoPostgre {
    ...
    * recupera uma lista de ContaPagar por data
        * return ArrayList
    */
    public ArrayList<ModelConta> getListaContasDAO(ModelConta pModelConta){
        ArrayList<ModelConta> listamodelContaPagar = new ArrayList();
        ModelConta modelConta = new ModelConta();
        try {
            this.conectar();
            this.executarSQL(
                "SELECT "
                    ...
                    + "tipo_conta"
                 + " FROM"
                     + " contas where situacao = '"+pModelConta.isSituacao() +"' AND pagamento = '"+pModelConta.getPagamento() +"'"
                + ";"
            );
