...
public class ViewPagamentoPDV extends javax.swing.JDialog {
    ...
    private void jtfValorRecebidoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfValorRecebidoFocusLost
        // TODO add your handling code here:
        this.jlfValorPagar.setText(new BLMascaras().arredondamentoComPonto(this.calcularDesconto())+"");
        this.jtfTroco.setText(new BLMascaras().arredondamentoComPonto(this.calcularTroco())+"");
   ...
   public void setTextFildValorTotal(){
       this.jtfSubtotal.setText(new BLMascaras().arredondamentoComPonto(this.valorTotal)+"");
   }
