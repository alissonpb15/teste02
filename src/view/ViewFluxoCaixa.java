...
public class ViewFluxoCaixa extends javax.swing.JFrame {
    ...
    private void jbVisualizarContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbVisualizarContaActionPerformed
        ...
        if (tipoCV.equals("VENDA")) {
            controllerContaPagar.gerarRelatorioContaVenda(codigo);
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     private void carregarContas() {
        ...
        try {
            modelConta.setPagamento(bl.converterDataParaDateUS(jdDataDia.getDate()));
        ...
        listaModelContas = controllerContaPagar.getListaContasController(modelConta);
        listaModelVendas = controllerVendas.getListaVendasController(modelVendas);
        modelo.setNumRows(0);
        String nomePessoa, tipoPagamento = "";
        //CARREGA OS DADOS DA LISTA NA TABELA as contas a pagar e receber
        ...
        for (int i = 0; i < cont; i++) {
            ...
            tipoPagamento = controllerTipoPagamento.getTipoPagamentoController(listaModelContas.get(i).getTipoPagamento()).getDescricao();
        ...
        for (int i = 0; i < cont2; i++) {
            ...
            tipoPagamento = controllerTipoPagamento.getTipoPagamentoController(listaModelVendas.get(i).getTipoPagamento()).getDescricao();
            modelo.addRow(new Object[]{
    ...
    private void somaEAtualizaValorTotal() {
       ...
       jlSaldoTotalCaixa.setText(String.valueOf(totalReceber - totalPagar));
    }
